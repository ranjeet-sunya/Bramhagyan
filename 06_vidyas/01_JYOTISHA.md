...
| Graha | Dominant Guna | Effect on Jiva |
|-------|---------------|----------------|
| **Surya** | Sattva | Clarity, authority, soul power |
| **Chandra** | Sattva-Rajas | Emotions, nurturing, receptivity |
| **Mangala** | Rajas-Tamas | Action, aggression, courage |
| **Budha** | Rajas-Sattva | Communication, logic, adaptability |
| **Brihaspati** | Sattva | Wisdom, expansion, spirituality |
| **Shukra** | Rajas | Beauty, pleasure, creativity |
| **Shani** | Tamas | Discipline, restriction, karma |
| **Rahu** | Tamas-Rajas | Obsession, illusion, worldly desires |
| **Ketu** | Sattva-Tamas | Detachment, spirituality, past karma |

### Graha Orbital Periods (Backend Time Units)

| Graha | Sidereal Period | Vedic Period Name | Ticks (approximate) |
|-------|-----------------|-------------------|---------------------|
| **Chandra** | 27.3 days | Masa (month) | 27 Nakshatras |
| **Surya** | 365.25 days | Varsha (year) | 12 Rashis |
| **Mangala** | 687 days | ~2 years | - |
| **Budha** | 88 days | ~3 months | - |
| **Brihaspati** | 11.86 years | Jupiter cycle | Important! |
| **Shukra** | 225 days | ~7.5 months | - |
| **Shani** | 29.5 years | Shani cycle | Major karma period |
...
The Moon passes through 27 Nakshatras in its orbit, each a distinct "frequency band."
...
| Element | Rashis | Mahabhuta | Guna Tendency |
|---------|--------|-----------|---------------|
| **Fire** | Mesha, Simha, Dhanu | Agni | Rajas |
| **Earth** | Vrishabha, Kanya, Makara | Prithvi | Tamas |
| **Air** | Mithuna, Tula, Kumbha | Vayu | Sattva-Rajas |
| **Water** | Karka, Vrischika, Meena | Jala | Sattva-Tamas |
...
| Graha | Years | Order | Karmic Theme |
|-------|-------|-------|--------------|
| **Ketu** | 7 | 1 | Spiritual initiation |
| **Shukra** | 20 | 2 | Material enjoyment |
| **Surya** | 6 | 3 | Self-realization |
| **Chandra** | 10 | 4 | Emotional growth |
| **Mangala** | 7 | 5 | Action & conflict |
| **Rahu** | 18 | 6 | Worldly ambition |
| **Brihaspati** | 16 | 7 | Wisdom & expansion |
| **Shani** | 19 | 8 | Karma balancing |
| **Budha** | 17 | 9 | Communication & trade |
| **Total** | **120** | | Full cycle |

### Dasha as Karma Activation

```
BACKEND MODEL:
--------------
Each Jiva starts from their birth Nakshatra's ruler.
...
```python
# Simplified mean longitude (actual uses complex ephemeris)
def mean_sun_longitude(julian_day: float) -> float:
    """
    Mean longitude of Sun
    
    Vedic: Surya's position in the zodiac
    """
    T = (julian_day - 2451545.0) / 36525  # Julian centuries from J2000
    L0 = 280.46646 + 36000.76983 * T + 0.0003032 * T**2
    return L0 % 360

def mean_moon_longitude(julian_day: float) -> float:
    """
    Mean longitude of Moon
    
    Vedic: Chandra's position (crucial for Nakshatra)
    """
...
```python
def nakshatra_from_longitude(moon_longitude: float) -> tuple:
    """
    ...
    pada = int((sidereal_longitude % 13.333333) / 3.333333) + 1
...
- [Fractal Cosmology](../spacetime/FRACTAL_COSMOLOGY.md)
- [Karma Algorithm](../karma/karma_algorithm.md)
